...
void main(){
    ...
    uv = 2.0*(uv - 0.5);
    // adjusting x coords to compinsate for stretching
    ...
    // col +=   patternfbm(uv*3.0 );
    gl_FragColor = vec4(pallete(map(displacement, 0.08, 0.4, 0.3, 0.9)), 1.0);
}